...
#修改默认 
sed -i '/country/a set wireless.default_radio${devidx}.legacy_rates=0 \nset wireless.default_radio${devidx}.mu_beamformer=1' package/kernel/mac80211/files/lib/wifi/mac80211.sh
